---
title: prefers-reduced-motion and Flutter animations
description: MediaQuery disableAnimations and designing calm alternatives.
seoDescription: Flutter reduced motion disableAnimations accessibility, calm animation alternatives. Practical guide for production
  Flutter teams.
keywords:
- reduced motion
- disableAnimations flutter
- accessible animation
- prefers-reduced-motion flutter
- flutter
- dart
- mobile development
- flutter tutorial
...
related:
- slug: flutter-navigation-restoration
  title: State restoration across process death
- slug: flutter-web-embed-existing-site
  title: Embedding Flutter into an existing marketing site
draft: false
---

Some users get sick from motion. Honor the platform setting. This article turns that observation into a small implementation model you can test, measure, and keep boring when the app grows.

## The problem in one sentence

MediaQuery disableAnimations and designing calm alternatives. The useful question is not whether the API or pattern looks elegant in isolation. It is where state lives, which boundary owns failure, and how a user recovers when the happy path disappears.

![Flutter architecture diagram for prefers-reduced-motion and Flutter animations](/blog/images/fluttercook-editorial-2026.svg)
...
For the neighboring ideas, read [State restoration across process death](/blog/flutter-navigation-restoration/) and [Embedding Flutter into an existing marketing site](/blog/flutter-web-embed-existing-site/).
