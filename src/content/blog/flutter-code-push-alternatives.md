---
title: Code push, hotfix, and what Apple/Google actually allow
description: OTAs, feature flags, and server-driven UI as safer alternatives.
seoDescription: Flutter code push OTA alternatives, server driven UI, feature flags hotfix. Practical guide for production
  Flutter teams.
keywords:
- code push flutter
- ota mobile apps
...
- name: Compatibility policy
  url: https://docs.flutter.dev/release/compatibility-policy
- name: Flutter documentation
  url: https://docs.flutter.dev/
- name: Dart documentation
  url: https://dart.dev/guides
related:
- slug: flutter-package-selection-checklist
  title: How to pick a Flutter package in 2026
- slug: flutter-migrate-material3-expressive
  title: Migrating large apps to Material 3 Expressive
draft: false
---

Full binary code push is restricted. Flags and server-driven UI cover most hotfixes. This article turns that observation into a small implementation model you can test, measure, and keep boring when the app grows.

## The problem in one sentence

OTAs, feature flags, and server-driven UI as safer alternatives. The useful question is not whether the API or pattern looks elegant in isolation. It is where state lives, which boundary owns failure, and how a user recovers when the happy path disappears.

![Flutter architecture diagram for Code push, hotfix, and what Apple/Google actually allow](/blog/images/fluttercook-editorial-2026.svg)
...
For the neighboring ideas, read [How to pick a Flutter package in 2026](/blog/flutter-package-selection-checklist/) and [Migrating large apps to Material 3 Expressive](/blog/flutter-migrate-material3-expressive/).
