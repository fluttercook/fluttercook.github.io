...
description: Where AR belongs and how to keep scope honest.
seoDescription: AR mobile visionos companion, scope ar features. Practical guide for production Flutter teams.
keywords:
- ar mobile
- visionos companion
- arkit flutter
...
AR is powerful and easy to overbuild. This article turns that observation into a small implementation model you can test, measure, and keep boring when the app grows.

## The problem in one sentence

Where AR belongs and how to keep scope honest. The useful question is not whether the API or pattern looks elegant in isolation. It is where state lives, which boundary owns failure, and how a user recovers when the happy path disappears.

![Flutter architecture diagram for AR and visionOS companions for mobile products](/blog/images/fluttercook-editorial-2026.svg)
...
For the neighboring ideas, read [Marketing on-device AI without lying](/blog/flutter-llm-on-device-privacy-marketing/) and [Storing tokens with Secure Enclave / StrongBox](/blog/flutter-secure-enclave-tokens/).
