...
Widget tests cannot open system dialogs. Patrol drives native UI alongside Flutter. This article turns that observation into a small implementation model you can test, measure, and keep boring when the app grows.

## The problem in one sentence

patrol, native automation, and CI device farms for Flutter. The useful question is not whether the API or pattern looks elegant in isolation. It is where state lives, which boundary owns failure, and how a user recovers when the happy path disappears.

![Flutter architecture diagram for Integration tests that survive real devices](/blog/images/fluttercook-editorial-2026.svg)
...
For the neighboring ideas, read [Obfuscation, symbols, and secrets in Flutter release builds](/blog/flutter-obfuscate-secrets-release/) and [Material 3 Expressive theming without fighting Flutter](/blog/flutter-material3-expressive-theming/).
