...
description: Component themes, regression goldens, and staged rollout.
seoDescription: Migrate Material 3 Expressive large app, component themes golden tests staged rollout. Practical guide for
...
sources:
- name: M3 migration
  url: https://docs.flutter.dev/release/breaking-changes/material-3-migration
- name: Flutter documentation
  url: https://docs.flutter.dev/
- name: Dart documentation
  url: https://dart.dev/guides
related:
- slug: flutter-testing-goldens-design-system
...
M3 migrations fail when done as big-bang UI rewrites. This article turns that observation into a small implementation model you can test, measure, and keep boring when the app grows.

## The problem in one sentence

Component themes, regression goldens, and staged rollout. The useful question is not whether the API or pattern looks elegant in isolation. It is where state lives, which boundary owns failure, and how a user recovers when the happy path disappears.

![Flutter architecture diagram for Migrating large apps to Material 3 Expressive](/blog/images/fluttercook-editorial-2026.svg)
...
For the neighboring ideas, read [Golden tests for design systems](/blog/flutter-testing-goldens-design-system/) and [DevTools Network and Memory views you should actually use](/blog/flutter-devtools-network-memory/).
