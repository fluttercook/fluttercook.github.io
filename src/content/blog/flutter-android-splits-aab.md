---
title: Android App Bundles, ABI splits, and download size
description: What Play optimizes for you and what you must still do.
seoDescription: Android app bundle ABI splits download size flutter aab. Practical guide for production Flutter teams.
keywords:
- android app bundle
- abi splits
- download size
...
related:
- slug: flutter-testflight-internal-external
  title: TestFlight internal vs external testing that finds real bugs
- slug: flutter-firebase-app-distribution
  title: Firebase App Distribution for Android/iOS betas
draft: false
---

AAB enables Play delivery optimizations; assets still matter. This article turns that observation into a small implementation model you can test, measure, and keep boring when the app grows.

## The problem in one sentence

What Play optimizes for you and what you must still do. The useful question is not whether the API or pattern looks elegant in isolation. It is where state lives, which boundary owns failure, and how a user recovers when the happy path disappears.

![Flutter architecture diagram for Android App Bundles, ABI splits, and download size](/blog/images/fluttercook-editorial-2026.svg)
...
For the neighboring ideas, read [TestFlight internal vs external testing that finds real bugs](/blog/flutter-testflight-internal-external/) and [Firebase App Distribution for Android/iOS betas](/blog/flutter-firebase-app-distribution/).
