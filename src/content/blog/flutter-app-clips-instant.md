...
Instant experiences convert. They also have brutal size budgets. This article turns that observation into a small implementation model you can test, measure, and keep boring when the app grows.

## The problem in one sentence

Size limits, invocation URLs, and handoff to full apps. The useful question is not whether the API or pattern looks elegant in isolation. It is where state lives, which boundary owns failure, and how a user recovers when the happy path disappears.

![Flutter architecture diagram for App Clips and Instant Apps with Flutter modules](/blog/images/fluttercook-editorial-2026.svg)
...
For the neighboring ideas, read [Passkeys and passwordless login in mobile apps](/blog/flutter-passkeys-passwordless/) and [Certificate pinning and network security on mobile](/blog/flutter-attestation-network-security/).
