...
description: Generate Kotlin/Swift codecs and stop hand-writing MethodChannel maps.
seoDescription: Flutter pigeon typed platform channels generate Kotlin Swift codec. Practical guide for production Flutter
  teams.
keywords:
- flutter pigeon
- typed method channels
- platform channel codegen
- flutter native types
- flutter
- dart
- mobile development
- flutter tutorial
...
- slug: flutter-code-push-alternatives
  title: Code push, hotfix, and what Apple/Google actually allow
draft: false
---

Hand-rolled channels break silently. Pigeon generates both ends. This article turns that observation into a small implementation model you can test, measure, and keep boring when the app grows.

## The problem in one sentence

Generate Kotlin/Swift codecs and stop hand-writing MethodChannel maps. The useful question is not whether the API or pattern looks elegant in isolation. It is where state lives, which boundary owns failure, and how a user recovers when the happy path disappears.

![Flutter architecture diagram for Pigeon: typed platform channels that scale](/blog/images/fluttercook-editorial-2026.svg)
...
For the neighboring ideas, read [flutter_rust_bridge for heavy compute in Flutter](/blog/flutter-rust-bridge-performance/) and [Code push, hotfix, and what Apple/Google actually allow](/blog/flutter-code-push-alternatives/).
