...
description: precache, ResizeImage, and avoiding 12MP avatars in chat lists.
seoDescription: Flutter image cache precache ResizeImage, memory cache list images, decode off main. Practical guide for production
  Flutter teams.
keywords:
- flutter image cache
- precacheImage
- ResizeImage flutter
- flutter list image memory
- image decode isolate
- flutter
- dart
- mobile development
...
Image decode is one of the most common raster-thread hogs in feed apps. This article turns that observation into a small implementation model you can test, measure, and keep boring when the app grows.

## The problem in one sentence

precache, ResizeImage, and avoiding 12MP avatars in chat lists. The useful question is not whether the API or pattern looks elegant in isolation. It is where state lives, which boundary owns failure, and how a user recovers when the happy path disappears.

![Flutter architecture diagram for Image caching and decode budgets in Flutter lists](/blog/images/fluttercook-editorial-2026.svg)
...
For the neighboring ideas, read [go_router deep links and URL strategies that scale](/blog/flutter-go-router-deep-links-2026/) and [Riverpod patterns that survive production scale](/blog/flutter-riverpod-3-patterns/).
