...
Context menus and tool palettes need more than one surface. Windowing APIs are how you get there. This article turns that observation into a small implementation model you can test, measure, and keep boring when the app grows.

## The problem in one sentence

Experimental windowing APIs accelerate with Canonical as desktop steward. The useful question is not whether the API or pattern looks elegant in isolation. It is where state lives, which boundary owns failure, and how a user recovers when the happy path disappears.

![Flutter architecture diagram for Desktop multi-window: popups, dialogs, and windowHandle](/blog/images/fluttercook-editorial-2026.svg)
...
For the neighboring ideas, read [Product flavors on Windows and Linux for CI matrices](/blog/flutter-desktop-flavors-ci/) and [Wasm deferred loading: split Flutter web for first paint](/blog/flutter-wasm-deferred-loading-strategy/).
