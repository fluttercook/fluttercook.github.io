...
description: Untranslated messages, plurals, and gender-aware copy.
seoDescription: Flutter localization arb gen_l10n, plurals, untranslated, i18n workflow. Practical guide for production Flutter
  teams.
keywords:
- flutter localization
- arb gen_l10n
- flutter i18n plurals
- flutter l10n
...
- slug: flutter-game-flame-product
  title: Shipping a 2D mini-game inside a Flutter product
draft: false
---

Ship the l10n pipeline early — retrofitting 200 strings is painful. This article turns that observation into a small implementation model you can test, measure, and keep boring when the app grows.

## The problem in one sentence

Untranslated messages, plurals, and gender-aware copy. The useful question is not whether the API or pattern looks elegant in isolation. It is where state lives, which boundary owns failure, and how a user recovers when the happy path disappears.

![Flutter architecture diagram for Flutter localization with ARB and gen_l10n that translators like](/blog/images/fluttercook-editorial-2026.svg)
...
For the neighboring ideas, read [Accessibility semantics checklist for Flutter forms](/blog/flutter-accessibility-semantics-checklist/) and [Shipping a 2D mini-game inside a Flutter product](/blog/flutter-game-flame-product/).
