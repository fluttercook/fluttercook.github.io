---
title: Flutter and iOS app extensions without a second UI stack — hướng dẫn Flutter
...
Extensions must stay tiny. Share logic via app groups and files. Bài này chuyển quan sát đó thành một mô hình nhỏ để bạn có thể kiểm thử, đo lường và giữ cho code dễ bảo trì khi app lớn lên.

## Vấn đề cốt lõi

Share extensions, widgets, and shared app groups. Câu hỏi hữu ích không phải API hay pattern có đẹp riêng lẻ hay không, mà là state nằm ở đâu, boundary nào chịu trách nhiệm khi lỗi xảy ra, và người dùng phục hồi thế nào khi happy path biến mất.

![Sơ đồ kiến trúc Flutter cho Flutter and iOS app extensions without a second UI stack](/blog/images/fluttercook-editorial-2026.svg)
...
Đọc thêm các chủ đề liên quan: [Home screen widgets with Flutter shells](/vi/blog/flutter-home-screen-widgets/) và [App Clips and Instant Apps with Flutter modules](/vi/blog/flutter-app-clips-instant/).
