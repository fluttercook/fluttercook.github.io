...
topics:
  ...
  - flutter
summary:
  - '**jiffy** là một thư viện & công cụ cho lập trình viên mã nguồn mở thuộc nhóm **Library/Tooling**.'
  - Dự án có **629★** và 139 fork, và được bảo trì tích cực.
  - 'Cài bằng `jiffy: ^latest` trong pubspec.yaml.'
