...
topics:
  ...
  - ios
summary:
  - '**isar** là một thư viện backend & dữ liệu mã nguồn mở thuộc nhóm **Backend/Data**.'
  - Dự án có **4,020★** và 606 fork, và trưởng thành và ổn định.
  - 'Cài bằng `isar: ^latest` trong pubspec.yaml.'
