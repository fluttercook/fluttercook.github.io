...
topics:
  ...
  - flare-flutter
summary:
  - '**giffy_dialog** là một thư viện hoạt ảnh mã nguồn mở thuộc nhóm **Animation**.'
  - Dự án có **660★** và 131 fork, và trưởng thành và ổn định.
  - 'Cài bằng `giffy_dialog: ^latest` trong pubspec.yaml.'
