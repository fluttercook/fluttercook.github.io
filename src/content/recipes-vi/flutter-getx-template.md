...
topics:
  ...
  - fcm
summary:
  - '**flutter_getx_template** là một thư viện quản lý trạng thái mã nguồn mở thuộc
    nhóm **State management**.'
  - Dự án có **515★** và 136 fork, và được bảo trì tích cực.
  - 'Cài bằng `flutter_getx_template: ^latest` trong pubspec.yaml.'
