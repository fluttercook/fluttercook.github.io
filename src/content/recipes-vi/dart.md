...
topics:
  ...
  - hacktoberfest
summary:
  - '**Dart** là một thư viện & công cụ cho lập trình viên mã nguồn mở thuộc nhóm **Library/Tooling**.'
  - Dự án có **2,141★** và 486 fork, và được bảo trì tích cực (cập nhật trong tháng
    qua).
  - 'Cài bằng `Dart: ^latest` trong pubspec.yaml.'
