...
topics:
  ...
  - web
summary:
  - '**kraken** là một thư viện & công cụ cho lập trình viên mã nguồn mở thuộc nhóm
    **Library/Tooling**.'
  - Dự án có **4,929★** và 303 fork, và trưởng thành và ổn định.
  - 'Cài bằng `kraken: ^latest` trong pubspec.yaml.'
