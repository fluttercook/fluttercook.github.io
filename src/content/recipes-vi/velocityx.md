...
topics:
  ...
  - hacktoberfest
summary:
  - '**VelocityX** là một thư viện thành phần giao diện (UI) mã nguồn mở thuộc nhóm
    **UI/Components**.'
  - Dự án có **1,504★** và 219 fork, và trưởng thành và ổn định.
  - 'Cài bằng `VelocityX: ^latest` trong pubspec.yaml.'
