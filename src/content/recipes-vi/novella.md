...
topics:
  ...
  - reader
summary:
  - '**Novella** là một thư viện & công cụ cho lập trình viên mã nguồn mở thuộc nhóm
    **Library/Tooling**.'
  - Dự án có **525★** và 13 fork, và được bảo trì tích cực (cập nhật trong tháng qua).
  - 'Cài bằng `Novella: ^latest` trong pubspec.yaml.'
