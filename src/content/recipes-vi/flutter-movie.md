...
topics:
  ...
  - flutter-examples
summary:
  - '**Flutter-Movie** là một thư viện quản lý trạng thái mã nguồn mở thuộc nhóm **State
    management**.'
  - Dự án có **738★** và 225 fork, và trưởng thành và ổn định.
  - 'Cài bằng `Flutter-Movie: ^latest` trong pubspec.yaml.'
