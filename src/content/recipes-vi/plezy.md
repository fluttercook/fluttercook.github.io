...
topics:
  ...
  - plex-api
summary:
  - '**plezy** là một thư viện thành phần giao diện (UI) mã nguồn mở thuộc nhóm **UI/Components**.'
  - Dự án có **2,886★** và 207 fork, và được bảo trì tích cực (cập nhật trong tháng
    qua).
  - 'Cài bằng `plezy: ^latest` trong pubspec.yaml.'
