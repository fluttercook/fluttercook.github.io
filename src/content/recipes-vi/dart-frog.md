...
topics:
  ...
  - dart-library
summary:
  - '**dart_frog** là một thư viện & công cụ cho lập trình viên mã nguồn mở thuộc nhóm
    **Library/Tooling**.'
  - Dự án có **2,266★** và 182 fork, và được bảo trì tích cực (cập nhật trong tháng
    qua).
  - 'Cài bằng `dart_frog: ^latest` trong pubspec.yaml.'
