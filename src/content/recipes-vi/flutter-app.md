...
topics:
  ...
  - http
summary:
  - '**flutter_app** là một thư viện backend & dữ liệu mã nguồn mở thuộc nhóm **Backend/Data**.'
  - Dự án có **2,702★** và 512 fork, và trưởng thành và ổn định.
  - 'Cài bằng `flutter_app: ^latest` trong pubspec.yaml.'
