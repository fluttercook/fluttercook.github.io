...
topics:
  ...
  - flutter
summary:
  - '**flutter_template** là một thư viện quản lý trạng thái mã nguồn mở thuộc nhóm
    **State management**.'
  - Dự án có **401★** và 82 fork, và trưởng thành và ổn định.
  - 'Cài bằng `flutter_template: ^latest` trong pubspec.yaml.'
