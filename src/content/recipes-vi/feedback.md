...
topics:
  ...
  - pub
summary:
  - '**feedback** là một thư viện thành phần giao diện (UI) mã nguồn mở thuộc nhóm **UI/Components**.'
  - Dự án có **439★** và 136 fork, và được bảo trì tích cực (cập nhật trong tháng qua).
  - 'Cài bằng `feedback: ^latest` trong pubspec.yaml.'
