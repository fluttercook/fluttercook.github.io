...
topics:
  ...
  - golang
summary:
  - '**go-flutter** là một thư viện & công cụ cho lập trình viên mã nguồn mở thuộc nhóm
    **Library/Tooling**.'
  - Dự án có **5,940★** và 278 fork, và được bảo trì tích cực (cập nhật trong tháng
    qua).
  - 'Cài bằng `go-flutter: ^latest` trong pubspec.yaml.'
