...
topics:
  ...
  - arkit
summary:
  - '**sceneview** là một bộ công cụ AI/ML mã nguồn mở thuộc nhóm **AI/ML**.'
  - Dự án có **1,257★** và 228 fork, và được bảo trì tích cực (cập nhật trong tháng
    qua).
  - 'Cài bằng `sceneview: ^latest` trong pubspec.yaml.'
