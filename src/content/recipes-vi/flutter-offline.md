...
topics:
  ...
  - flutter
summary:
  - '**flutter_offline** là một thư viện thành phần giao diện (UI) mã nguồn mở thuộc
    nhóm **UI/Components**.'
  - Dự án có **1,324★** và 130 fork, và ổn định, có cập nhật trong năm qua.
  - 'Cài bằng `flutter_offline: ^latest` trong pubspec.yaml.'
