...
topics:
  ...
  - github-actions
summary:
  - '**flutter-action** là một thư viện & công cụ cho lập trình viên mã nguồn mở thuộc
    nhóm **Library/Tooling**.'
  - Dự án có **2,599★** và 264 fork, và được bảo trì tích cực.
  - 'Cài bằng `flutter-action: ^latest` trong pubspec.yaml.'
