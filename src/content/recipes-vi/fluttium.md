...
topics:
  ...
  - flutter
summary:
  - '**fluttium** là một thư viện & công cụ cho lập trình viên mã nguồn mở thuộc nhóm
    **Library/Tooling**.'
  - Dự án có **372★** và 9 fork, và trưởng thành và ổn định.
  - 'Cài bằng `fluttium: ^latest` trong pubspec.yaml.'
