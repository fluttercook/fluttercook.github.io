...
topics:
  []
summary:
  - '**serverpod** là một thư viện thành phần giao diện (UI) mã nguồn mở thuộc nhóm
    **UI/Components**.'
  - Dự án có **3,225★** và 368 fork, và được bảo trì tích cực (cập nhật trong tháng
    qua).
  - 'Cài bằng `serverpod: ^latest` trong pubspec.yaml.'
