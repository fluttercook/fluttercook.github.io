...
topics:
  ...
  - stable-diffusion
summary:
  - '**aidea** là một bộ công cụ AI/ML mã nguồn mở thuộc nhóm **AI/ML**.'
  - Dự án có **6,931★** và 1,050 fork, và được bảo trì tích cực.
  - 'Cài bằng `aidea: ^latest` trong pubspec.yaml.'
