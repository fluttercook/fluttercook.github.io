...
topics:
  ...
  - router
summary:
  - '**flow_builder** là một thư viện điều hướng & định tuyến mã nguồn mở thuộc nhóm
    **Navigation**.'
  - Dự án có **416★** và 68 fork, và trưởng thành và ổn định.
  - 'Cài bằng `flow_builder: ^latest` trong pubspec.yaml.'
