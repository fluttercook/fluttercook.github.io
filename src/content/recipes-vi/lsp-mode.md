...
topics:
  ...
  - golang
summary:
  - '**lsp-mode** là một thư viện & công cụ cho lập trình viên mã nguồn mở thuộc nhóm
    **Library/Tooling**.'
  - Dự án có **5,105★** và 973 fork, và được bảo trì tích cực (cập nhật trong tháng
    qua).
  - 'Cài bằng `lsp-mode: ^latest` trong pubspec.yaml.'
