...
topics:
  []
summary:
  - '**packages** là một thư viện & công cụ cho lập trình viên mã nguồn mở thuộc nhóm
    **Library/Tooling**.'
  - Dự án có **5,261★** và 3,810 fork, và được bảo trì tích cực (cập nhật trong tháng
    qua).
  - 'Cài bằng `packages: ^latest` trong pubspec.yaml.'
