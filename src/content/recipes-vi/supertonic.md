...
topics:
  ...
  - java
summary:
  - '**supertonic** là một thư viện & công cụ cho lập trình viên mã nguồn mở thuộc nhóm
    **Library/Tooling**.'
  - Dự án có **13,196★** và 1,358 fork, và được bảo trì tích cực (cập nhật trong tháng
    qua).
  - 'Cài bằng `supertonic: ^latest` trong pubspec.yaml.'
