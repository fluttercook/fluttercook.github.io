...
topics:
  ...
  - cloud-native
summary:
  - '**nitric** là một bộ công cụ AI/ML mã nguồn mở thuộc nhóm **AI/ML**.'
  - Dự án có **2,000★** và 121 fork, và được bảo trì tích cực.
  - 'Cài bằng `nitric: ^latest` trong pubspec.yaml.'
