...
topics:
  ...
  - ui
summary:
  - '**rive-flutter** là một thư viện hoạt ảnh mã nguồn mở thuộc nhóm **Animation**.'
  - Dự án có **1,493★** và 235 fork, và được bảo trì tích cực (cập nhật trong tháng
    qua).
  - 'Cài bằng `rive-flutter: ^latest` trong pubspec.yaml.'
