...
topics:
  []
summary:
  - '**tdesign-flutter** là một thư viện thành phần giao diện (UI) mã nguồn mở thuộc
    nhóm **UI/Components**.'
  - Dự án có **1,168★** và 181 fork, và được bảo trì tích cực (cập nhật trong tháng
    qua).
  - 'Cài bằng `tdesign-flutter: ^latest` trong pubspec.yaml.'
