...
topics:
  ...
  - fvm
summary:
  - '**fvm** là một thư viện & công cụ cho lập trình viên mã nguồn mở thuộc nhóm **Library/Tooling**.'
  - Dự án có **5,490★** và 283 fork, và được bảo trì tích cực (cập nhật trong tháng
    qua).
  - 'Cài bằng `fvm: ^latest` trong pubspec.yaml.'
