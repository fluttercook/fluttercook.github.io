...
topics:
  ...
  - slider
summary:
  - '**before_after** là một thư viện & công cụ cho lập trình viên mã nguồn mở thuộc
    nhóm **Library/Tooling**.'
  - Dự án có **1,031★** và 109 fork, và trưởng thành và ổn định.
  - 'Cài bằng `before_after: ^latest` trong pubspec.yaml.'
