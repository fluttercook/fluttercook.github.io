...
topics:
  ...
  - getx
summary:
  - '**getx** là một thư viện quản lý trạng thái mã nguồn mở thuộc nhóm **State management**.'
  - Dự án có **11,191★** và 1,849 fork, và được bảo trì tích cực.
  - 'Cài bằng `getx: ^latest` trong pubspec.yaml.'
