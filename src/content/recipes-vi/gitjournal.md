...
topics:
  ...
  - markdown
summary:
  - '**GitJournal** là một thư viện & công cụ cho lập trình viên mã nguồn mở thuộc nhóm
    **Library/Tooling**.'
  - Dự án có **4,187★** và 301 fork, và được bảo trì tích cực.
  - 'Cài bằng `GitJournal: ^latest` trong pubspec.yaml.'
