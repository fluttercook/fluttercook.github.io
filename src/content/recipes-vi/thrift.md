...
topics:
  ...
  - dart
summary:
  - '**thrift** là một thư viện & công cụ cho lập trình viên mã nguồn mở thuộc nhóm
    **Library/Tooling**.'
  - Dự án có **10,934★** và 4,111 fork, và được bảo trì tích cực (cập nhật trong tháng
    qua).
  - 'Cài bằng `thrift: ^latest` trong pubspec.yaml.'
