...
topics:
  []
summary:
  - '**skills** là một thư viện & công cụ cho lập trình viên mã nguồn mở thuộc nhóm
    **Library/Tooling**.'
  - Dự án có **403★** và 25 fork, và được bảo trì tích cực (cập nhật trong tháng qua).
  - 'Cài bằng `skills: ^latest` trong pubspec.yaml.'
