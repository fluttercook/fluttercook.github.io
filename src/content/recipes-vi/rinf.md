...
topics:
  ...
  - flutter
summary:
  - '**rinf** là một thư viện thành phần giao diện (UI) mã nguồn mở thuộc nhóm **UI/Components**.'
  - Dự án có **2,738★** và 112 fork, và được bảo trì tích cực (cập nhật trong tháng
    qua).
  - 'Cài bằng `rinf: ^latest` trong pubspec.yaml.'
