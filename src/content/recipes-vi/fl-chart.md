...
topics:
  ...
  - charts
summary:
  - '**fl_chart** là một thư viện thành phần giao diện (UI) mã nguồn mở thuộc nhóm **UI/Components**.'
  - Dự án có **7,554★** và 1,967 fork, và được bảo trì tích cực.
  - 'Cài bằng `fl_chart: ^latest` trong pubspec.yaml.'
