...
topics:
  ...
  - flutter-package
summary:
  - '**flutter-quill** là một thư viện thành phần giao diện (UI) mã nguồn mở thuộc nhóm
    **UI/Components**.'
  - Dự án có **2,911★** và 1,045 fork, và được bảo trì tích cực (cập nhật trong tháng
    qua).
  - 'Cài bằng `flutter-quill: ^latest` trong pubspec.yaml.'
