...
topics:
  ...
  - oracle
summary:
  - '**openhare** là một bộ công cụ AI/ML mã nguồn mở thuộc nhóm **AI/ML**.'
  - Dự án có **712★** và 39 fork, và được bảo trì tích cực (cập nhật trong tháng qua).
  - 'Cài bằng `openhare: ^latest` trong pubspec.yaml.'
