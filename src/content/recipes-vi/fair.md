...
topics:
  ...
  - flutter
summary:
  - '**Fair** là một thư viện thành phần giao diện (UI) mã nguồn mở thuộc nhóm **UI/Components**.'
  - Dự án có **2,738★** và 321 fork, và trưởng thành và ổn định.
  - 'Cài bằng `Fair: ^latest` trong pubspec.yaml.'
