...
topics:
  ...
  - graphql
summary:
  - '**graphql-flutter** là một thư viện backend & dữ liệu mã nguồn mở thuộc nhóm **Backend/Data**.'
  - Dự án có **3,271★** và 641 fork, và được bảo trì tích cực (cập nhật trong tháng
    qua).
  - 'Cài bằng `graphql-flutter: ^latest` trong pubspec.yaml.'
