...
topics:
  ...
  - flutter
summary:
  - '**namida** là một thư viện backend & dữ liệu mã nguồn mở thuộc nhóm **Backend/Data**.'
  - Dự án có **6,014★** và 325 fork, và được bảo trì tích cực (cập nhật trong tháng
    qua).
  - 'Cài bằng `namida: ^latest` trong pubspec.yaml.'
