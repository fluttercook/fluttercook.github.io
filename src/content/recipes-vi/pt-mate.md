...
topics:
  ...
  - pt
summary:
  - '**pt_mate** là một thư viện thành phần giao diện (UI) mã nguồn mở thuộc nhóm **UI/Components**.'
  - Dự án có **475★** và 32 fork, và được bảo trì tích cực (cập nhật trong tháng qua).
  - 'Cài bằng `pt_mate: ^latest` trong pubspec.yaml.'
