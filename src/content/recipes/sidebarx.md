---
title: "Flutter navigation done right with sidebarx"
package: "sidebarx"
...
seoDescription: "sidebarx: Navigation for Flutter with 346★ on GitHub. Flutter multiplatform navigation sidebar / side navigation bar / drawer widget. Install, usage,…"
keywords:
  - flutter sidebarx
  - sidebarx flutter
  - flutter navigation
...
faq:
  - q: Is sidebarx free to use?
    a: Yes. sidebarx is open source and free to use in your Flutter projects. You can
      view the source, report issues, and contribute on GitHub.
  - q: Does sidebarx work on both iOS and Android?
    a: sidebarx is built for Flutter, so it targets iOS and Android from a single codebase,
      and typically web and desktop too depending on the project's platform support.
  - q: How popular is sidebarx?
    a: As of 2026, sidebarx has around 346 stars and 55 forks on GitHub, which puts
      it among the more widely used options in the Navigation space.
  - q: What are good alternatives to sidebarx?
  ...
  - q: How do I install sidebarx?
    a: Add sidebarx to the dependencies section of your pubspec.yaml and run flutter
...
[`sidebarx`](https://github.com/Frezyx/sidebarx) is an open-source **navigation & routing library** for Flutter mobile app development, with **346★** on GitHub and last updated on **2025-07-30**. This guide covers what sidebarx does, why it matters in 2026, how to add it to your project, when to reach for it, and how it compares to the alternatives — plus a quick FAQ.

## What is sidebarx?

Flutter multiplatform navigation sidebar / side navigation bar / drawer widget. It focuses on structuring screens, routes, and deep links. The project lives at [Frezyx/sidebarx](https://github.com/Frezyx/sidebarx) and is maintained by `Frezyx`.
...
Check the package's `example/` directory and its [pub.dev page](https://pub.dev/packages/sidebarx) for the exact API — sidebarx is versioned there with full docs so you always integrate against the current release.
...
- **Video tutorials:** [search YouTube for sidebarx](https://www.youtube.com/results?search_query=flutter+sidebarx)
