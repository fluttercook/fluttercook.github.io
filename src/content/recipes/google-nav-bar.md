...
seoDescription: "google_nav_bar: Navigation for Flutter with 790★ on GitHub. A modern google style nav bar for flutter. Install, usage, alternatives & FAQ."
keywords:
  ...
  - flutter routing
  - flutter mobile app
  - google_nav_bar example
  - google_nav_bar tutorial
topics:
  - bottombar
  - bottomnavigationbar
  - bubble-navigation
...
faq:
  - q: Is google_nav_bar free to use?
    a: Yes. google_nav_bar is open source and free to use in your Flutter projects.
      You can view the source, report issues, and contribute on GitHub.
  - q: Does google_nav_bar work on both iOS and Android?
    a: google_nav_bar is built for Flutter, so it targets iOS and Android from a single
      codebase, and typically web and desktop too depending on the project's platform
      support.
  - q: How popular is google_nav_bar?
    a: As of 2026, google_nav_bar has around 790 stars and 117 forks on GitHub, which
      puts it among the more widely used options in the Navigation space.
  - q: What are good alternatives to google_nav_bar?
    a: Popular alternatives in the Navigation category include lantern, fluro, luci-mobile.
      The best choice depends on your app's size, team, and performance needs.
  - q: How do I install google_nav_bar?
    a: Add google_nav_bar to the dependencies section of your pubspec.yaml and run flutter
...
[`google_nav_bar`](https://github.com/sooxt98/google_nav_bar) is an open-source **navigation & routing library** for Flutter mobile app development, with **790★** on GitHub and last updated on **2024-11-30**. This guide covers what google_nav_bar does, why it matters in 2026, how to add it to your project, when to reach for it, and how it compares to the alternatives — plus a quick FAQ.

## What is google_nav_bar?

A modern google style nav bar for flutter. It focuses on structuring screens, routes, and deep links. The project lives at [sooxt98/google_nav_bar](https://github.com/sooxt98/google_nav_bar) and is maintained by `sooxt98`.
...
Check the package's `example/` directory and its [pub.dev page](https://pub.dev/packages/google_nav_bar) for the exact API — google_nav_bar is versioned there with full docs so you always integrate against the current release.
...
- [Flutter navigation done right with flow_builder](/recipes/flow-builder/)
...
- **Video tutorials:** [search YouTube for google_nav_bar](https://www.youtube.com/results?search_query=flutter+google-nav-bar)
