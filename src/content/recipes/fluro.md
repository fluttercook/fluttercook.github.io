...
seoDescription: "fluro: Navigation for Flutter with 3,713★ on GitHub. Fluro is a Flutter routing library that adds flexible routing options like wildcards, named parameters…"
keywords:
  - flutter fluro
  - fluro flutter
  - flutter navigation
...
faq:
  - q: Is fluro free to use?
    a: Yes. fluro is open source and free to use in your Flutter projects. You can view
      the source, report issues, and contribute on GitHub.
  - q: Does fluro work on both iOS and Android?
    a: fluro is built for Flutter, so it targets iOS and Android from a single codebase,
      and typically web and desktop too depending on the project's platform support.
  - q: How popular is fluro?
    a: As of 2026, fluro has around 3,713 stars and 409 forks on GitHub, which puts
      it among the more widely used options in the Navigation space.
  - q: What are good alternatives to fluro?
    a: Popular alternatives in the Navigation category include lantern, google-nav-bar,
...
[`fluro`](https://github.com/lukepighetti/fluro) is an open-source **navigation & routing library** for Flutter mobile app development, with **3,713★** on GitHub and last updated on **2023-03-22**. This guide covers what fluro does, why it matters in 2026, how to add it to your project, when to reach for it, and how it compares to the alternatives — plus a quick FAQ.

## What is fluro?

Fluro is a Flutter routing library that adds flexible routing options like wildcards, named parameters and clear route definitions. It focuses on structuring screens, routes, and deep links. The project lives at [lukepighetti/fluro](https://github.com/lukepighetti/fluro) and is maintained by `lukepighetti`.
...
Check the package's `example/` directory and its [GitHub repo](https://github.com/lukepighetti/fluro) for the exact API — fluro is versioned there with full docs so you always integrate against the current release.
...
- **Video tutorials:** [search YouTube for fluro](https://www.youtube.com/results?search_query=flutter+fluro)
