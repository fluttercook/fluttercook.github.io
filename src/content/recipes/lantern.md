...
seoDescription: "lantern: Navigation for Flutter with 15,800★ on GitHub. Open-source VPN for speed, privacy, and censorship circumvention. Free to download on Android, iOS,…"
keywords:
  - flutter lantern
  - lantern flutter
  - flutter navigation
...
faq:
  - q: Is lantern free to use?
    a: Yes. lantern is open source and free to use in your Flutter projects. You can
      view the source, report issues, and contribute on GitHub.
  - q: Does lantern work on both iOS and Android?
    a: lantern is built for Flutter, so it targets iOS and Android from a single codebase,
      and typically web and desktop too depending on the project's platform support.
  - q: How popular is lantern?
    a: As of 2026, lantern has around 15,800 stars and 11,076 forks on GitHub, which
      puts it among the more widely used options in the Navigation space.
  - q: What are good alternatives to lantern?
    a: Popular alternatives in the Navigation category include fluro, google-nav-bar,
      luci-mobile. The best choice depends on your app's size, team, and performance
      needs.
...
[`lantern`](https://github.com/getlantern/lantern) is an open-source **navigation & routing library** for Flutter mobile app development, with **15,800★** on GitHub and last updated on **2026-07-15**. This guide covers what lantern does, why it matters in 2026, how to add it to your project, when to reach for it, and how it compares to the alternatives — plus a quick FAQ.

## What is lantern?

Open-source VPN for speed, privacy, and censorship circumvention. Free to download on Android, iOS, Windows, macOS, and Linux. It focuses on structuring screens, routes, and deep links. The project lives at [getlantern/lantern](https://github.com/getlantern/lantern) and is maintained by `getlantern`.
...
Check the package's `example/` directory and its [GitHub repo](https://github.com/getlantern/lantern) for the exact API — lantern is versioned there with full docs so you always integrate against the current release.
...
- **Video tutorials:** [search YouTube for lantern](https://www.youtube.com/results?search_query=flutter+lantern)
