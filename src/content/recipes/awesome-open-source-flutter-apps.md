...
seoDescription: "awesome-open-source-flutter-apps: Learning/Awesome for Flutter with 2,998★ on GitHub. A curated list of awesome open source Flutter apps. Install, usage,…"
keywords:
  ...
  - flutter tutorials
  - flutter mobile app
  - awesome-open-source-flutter-apps example
  - awesome-open-source-flutter-apps tutorial
topics:
  - flutter
  - flutter-app
  - flutter-apps
...
faq:
  - q: Is awesome-open-source-flutter-apps free to use?
    a: Yes. awesome-open-source-flutter-apps is open source and free to use in your
      Flutter projects. You can view the source, report issues, and contribute on GitHub.
  - q: Does awesome-open-source-flutter-apps work on both iOS and Android?
    a: awesome-open-source-flutter-apps is built for Flutter, so it targets iOS and
      Android from a single codebase, and typically web and desktop too depending on
      the project's platform support.
  - q: How popular is awesome-open-source-flutter-apps?
    a: As of 2026, awesome-open-source-flutter-apps has around 2,998 stars and 450 forks
      on GitHub, which puts it among the more widely used options in the Learning/Awesome
      space.
  - q: What are good alternatives to awesome-open-source-flutter-apps?
...
[`awesome-open-source-flutter-apps`](https://github.com/fluttergems/awesome-open-source-flutter-apps) is an open-source **curated learning resource** for Flutter mobile app development, with **2,998★** on GitHub and last updated on **2026-05-17**. This guide covers what awesome-open-source-flutter-apps does, why it matters in 2026, how to add it to your project, when to reach for it, and how it compares to the alternatives — plus a quick FAQ.

## What is awesome-open-source-flutter-apps?

A curated list of awesome open source Flutter apps. It focuses on finding the best Flutter examples, tutorials, and references. The project lives at [fluttergems/awesome-open-source-flutter-apps](https://github.com/fluttergems/awesome-open-source-flutter-apps) and is maintained by `fluttergems`.
...
- **Video tutorials:** [search YouTube for awesome-open-source-flutter-apps](https://www.youtube.com/results?search_query=flutter+awesome-open-source-flutter-apps)
