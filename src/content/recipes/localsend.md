...
topics:
  ...
  - flutter-apps
summary:
  - '**localsend** is an open-source open-source app / starter template in the **App/Template**
    category.'
  - It has **85,396★** and 4,686 forks, and is actively maintained (updated within the
    last month).
